 ...
 * Modified to support photonic activations.
 ******************************************************************************/
...
#include "selective_scan_photonic.h"
...
// Convert Python int to PhotonicActivationType
PhotonicActivationType int_to_activation_type(int act_int) {
    switch(act_int) {
        case 0: return PhotonicActivationType::STANDARD;
        case 1: return PhotonicActivationType::PSIGMOID;
        case 2: return PhotonicActivationType::PSINUSOIDAL;
        case 3: return PhotonicActivationType::PTANHLIKE;
        case 4: return PhotonicActivationType::PELULIKE;
        case 5: return PhotonicActivationType::PINVELU;
        case 6: return PhotonicActivationType::PDSINSQ;
        case 7: return PhotonicActivationType::PRESIN;
        case 8: return PhotonicActivationType::PEXPSIN;
        default: return PhotonicActivationType::STANDARD;
    }
}
...
void set_ssm_params_fwd(SSMParamsBase &params,
                        ...
                        bool has_z,
                        bool delta_softplus,
                        int delta_activation_type,
                        int gate_activation_type) {
    ...
    params.delta_activation_type = int_to_activation_type(delta_activation_type);
    params.gate_activation_type = int_to_activation_type(gate_activation_type);
...
void set_ssm_params_bwd(SSMParamsBwd &params,
    ...
    set_ssm_params_fwd(params, batch, dim, seqlen, dstate, n_groups, n_chunks, is_variable_B, is_variable_C,
                       ...
                       D_ptr, delta_bias_ptr, x_ptr, has_z, delta_softplus, delta_activation_type, gate_activation_type);
...
selective_scan_fwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    set_ssm_params_fwd(params, batch_size, dim, seqlen, dstate, n_groups, n_chunks, is_variable_B, is_variable_C,
                       ...
                       has_z,
                       delta_softplus,
                       delta_activation_type,
                       gate_activation_type);
...
selective_scan_bwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    set_ssm_params_bwd(params, batch_size, dim, seqlen, dstate, n_groups, n_chunks, is_variable_B, is_variable_C,
                       ...
                       has_z, delta_softplus, recompute_out_z, delta_activation_type, gate_activation_type);
