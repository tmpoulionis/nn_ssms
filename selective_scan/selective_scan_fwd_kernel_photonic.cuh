...
void selective_scan_fwd_kernel(SSMParamsBase params) {
    ...
    // Get photonic activation types from params
    ...
    const bool use_delta_activation = params.delta_softplus || 
    ...
    for (int chunk = 0; chunk < params.n_chunks; ++chunk) {
        ...
        for (int r = 0; r < kNRows; ++r) {
            ...
            for (int i = 0; i < kNItems; ++i) {
                ...
                // MODIFIED: Use photonic activation for delta instead of softplus
                if (use_delta_activation) {
                    delta_vals[r][i] = photonic_delta_activation_fwd(
                        delta_vals[r][i], 
                        delta_act_type,
                        params.delta_softplus
                    );
                }
