...
#include "photonic_activations.cuh"
...
struct SSMParamsBase {
    ...
    bool is_variable_C;
    bool delta_softplus;
    // NEW: Photonic activation types
    PhotonicActivationType delta_activation_type;  // For delta/softplus replacement
    PhotonicActivationType gate_activation_type;   // For z/silu replacement
