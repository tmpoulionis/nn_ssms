'''Adapted from S4 "https://github.com/state-spaces/s4" with photonic activations integration.'''

import math
import torch
import torch.nn as nn
import torch.nn.functional as F
import utils.photonic_activations as pa

def Activation(activation=None, size=None, dim=-1):
    if activation == 'psigmoid':
        return pa.PSigmoid()
